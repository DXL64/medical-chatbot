...
export const diseasesTranslations = {
  "Hypertensive disease": "Bệnh tăng huyết áp",
  "Coronavirus disease 2019": "Bệnh do vi-rút corona 2019",
  Diabetes: "Bệnh tiểu đường",
  "Depression mental": "Trầm cảm tâm thần",
  "Depressive disorder": "Rối loạn trầm cảm",
  "Coronary arteriosclerosis": "Xơ cứng động mạch vành",
  "Coronary heart disease": "Bệnh tim mạch vành",
  Pneumonia: "Viêm phổi",
  "Failure heart congestive": "Suy tim sung huyết",
  "Accident cerebrovascular": "Tai nạn mạch máu não",
  Asthma: "Hen suyễn",
  "Myocardial infarction": "Nhồi máu cơ tim",
  Hypercholesterolemia: "Tăng cholesterol máu",
  Infection: "Sự nhiễm trùng",
  "Infection urinary tract": "Nhiễm trùng đường tiết niệu",
  Anemia: "Thiếu máu",
  "Chronic obstructive airway disease": "Bệnh tắc nghẽn đường hô hấp mãn tính",
  Dementia: "Chứng mất trí nhớ",
  "Insufficiency renal": "Suy thận",
  Confusion: "Lú lẫn",
  "Degenerative polyarthritis": "Viêm đa khớp thoái hóa",
  Hypothyroidism: "Suy giáp",
  "Anxiety state": "Trạng thái lo lắng",
  "Malignant neoplasms": "Khối u ác tính",
  "Primary malignant neoplasm": "Khối u ác tính nguyên phát",
  "Acquired immuno-deficiency syndrome":
    "Hội chứng suy giảm miễn dịch mắc phải",
  Hiv: "Hiv",
  "Hiv infections": "Nhiễm hiv",
  Cellulitis: "Viêm mô tế bào",
  "Gastroesophageal reflux disease": "Bệnh trào ngược dạ dày thực quản",
  Septicemia: "Nhiễm trùng huyết",
  "Systemic infection": "Nhiễm trùng toàn thân",
  "Sepsis (invertebrate)": "Nhiễm trùng huyết (động vật không xương sống)",
  "Deep vein thrombosis": "Huyết khối tĩnh mạch sâu",
  Dehydration: "Mất nước",
  Neoplasm: "Tân sinh",
  "Embolism pulmonary": "Thuyên tắc phổi",
  ...
  Cirrhosis: "Xơ gan",
  Exanthema: "Phát ban",
  "Benign prostatic hypertrophy": "Phì đại tuyến tiền liệt lành tính",
  "Kidney failure acute": "Suy thận cấp tính",
  "Mitral valve insufficiency": "Suy van hai lá",
  Arthritis: "Viêm khớp",
  ...
  Incontinence: "Không tự chủ",
  "Paroxysmal dyspnea": "Khó thở kịch phát",
  Hernia: "Thoát vị",
  "Malignant neoplasm of prostate": "U ác tính của tuyến tiền liệt",
  "Carcinoma prostate": "Ung thư tuyến tiền liệt",
  "Edema pulmonary": "Phù phổi",
  "Lymphatic diseases": "Bệnh bạch huyết",
  "Stenosis aortic valve": "Hẹp van động mạch chủ",
  "Malignant neoplasm of breast": "Khối u ác tính của vú",
  "Carcinoma breast": "Ung thư vú",
  Schizophrenia: "Tâm thần phân liệt",
  Diverticulitis: "Viêm túi thừa",
  "Overload fluid": "Chất lỏng quá tải",
  "Ulcer peptic": "Loét dạ dày",
  Osteomyelitis: "Viêm xương tủy",
  Gastritis: "Viêm dạ dày",
  Bacteremia: "Nhiễm khuẩn huyết",
  "Failure kidney": "Suy thận",
  "Sickle cell anemia": "Thiếu máu hồng cầu hình liềm",
  "Failure heart": "Trái tim thất bại",
  "Upper respiratory infection": "Nhiễm trùng đường hô hấp trên",
  Hepatitis: "Viêm gan",
  "Hypertension pulmonary": "Tăng huyết áp phổi",
  "Deglutition disorder": "Rối loạn tiêu hóa",
  Gout: "Bệnh gout",
  Thrombocytopaenia: "Giảm tiểu cầu",
  Hypoglycemia: "Hạ đường huyết",
  "Pneumonia aspiration": "Hút viêm phổi",
  Colitis: "Viêm đại tràng",
  Diverticulosis: "Bệnh túi thừa",
  "Suicide attempt": "Nỗ lực tự tử",
  ...
  "Tricuspid valve insufficiency": "Suy van ba lá",
  "Alzheimer's disease": "Bệnh alzheimer",
  Candidiasis: "Bệnh nấm candida",
  Oralcandidiasis: "Bệnh nấm miệng",
  Neuropathy: "Bệnh thần kinh",
  "Kidney disease": "Bệnh thận",
  "Fibroid tumor": "Khối u xơ",
  Glaucoma: "Bệnh tăng nhãn áp",
  "Neoplasm metastasis": "Di căn tân sinh",
  "Malignant tumor of colon": "Khối u ác tính của đại tràng",
  "Carcinoma colon": "Ung thư đại tràng",
  "Ketoacidosis diabetic": "Bệnh tiểu đường nhiễm toan ceton",
  "Tonic-clonic epilepsy": "Động kinh tăng trương lực",
  "Tonic-clonic seizures": "Co giật tăng trương lực",
  "Malignant neoplasms": "Khối u ác tính",
  "Respiratory failure": "Suy hô hấp",
  Melanoma: "Khối u ác tính",
  Gastroenteritis: "Viêm dạ dày ruột",
  "Malignant neoplasm of lung": "U ác của phổi",
  "Carcinoma of lung": "Ung thư phổi",
  "Manic disorder": "Rối loạn hưng cảm",
  "Personality disorder": "Rối loạn nhân cách",
  "Primary carcinoma of the liver cells": "Ung thư tế bào gan nguyên phát",
  "Emphysema pulmonary": "Khí thũng phổi",
  Hemorrhoids: "Bệnh trĩ",
  "Spasm bronchial": "Co thắt phế quản",
  Aphasia: "Chứng mất ngôn ngữ",
  "Obesity morbid": "Bệnh béo phì",
  Pyelonephritis: "Viêm bể thận",
  Endocarditis: "Viêm nội tâm mạc",
  "Effusion pericardial": "Tràn dịch màng ngoài tim",
  "Pericardial effusion body substance": "Chất tràn dịch màng ngoài tim",
  "Chronic alcoholic intoxication": "Ngộ độc rượu mãn tính",
  ...
  "Hernia hiatal": "Thoát vị gián đoạn",
  "Migraine disorders": "Rối loạn đau nửa đầu",
  Pancytopenia: "Giảm toàn thể huyết cầu",
  Cholelithiasis: "Bệnh sỏi mật",
  "Biliary calculus": "Tính toán đường mật",
  "Tachycardia sinus": "Nhịp tim nhanh xoang",
  Ileus: "Tắc ruột",
  Adhesion: "Độ bám dính",
  Delusion: "Ảo tưởng",
  "Affect labile": "Ảnh hưởng không bền",
  "Decubitus ulcer": "Loét tư thế nằm",
};

export const diseases2Translations = {
  "(vertigo) Paroymsal  Positional Vertigo":
    "(Vertigo) Vertigo vị trí paroxysmal",
  AIDS: "AIDS",
  Acne: "Mụn trứng cá",
  ...
  "Cervical spondylosis": "Viêm thắt cổ tử cung",
  "Chicken pox": "Thủy đậu",
  "Chronic cholestasis": "Cholestocation mãn tính",
  "Common Cold": "Cảm lạnh thông thường",
  Dengue: "Sốt xuất huyết",
  Diabetes: "Bệnh tiểu đường",
  "Dimorphic hemmorhoids(piles)": "Hemmorhoid lưỡng hình (cọc)",
  "Drug Reaction": "Phản ứng thuốc",
  "Fungal infection": "Nhiễm trùng nấm",
  GERD: "Gerd",
  Gastroenteritis: "Viêm tiêu hóa",
  ...
  "Varicose veins": "Tĩnh mạch giãn tĩnh mạch",
